...
import AdminVendorManagerRepository from '@admin/auth/domain/repositories/vendors/admin-vendor-manager-repository';
import { AdminVendorManagerEntity } from '@admin/auth/infrastructure/persistance/typeorm/entities/admin-vendor-manager-entity'; // Replace with the actual path to the AdminRestaurantManagerRepository interface
