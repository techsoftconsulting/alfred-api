...
import ScreensRestaurantCategoryInfrastructureCommandRepository from '@screens/auth/infrastructure/persistance/typeorm/repositories/screens-restaurant-category-infrastructure-command-repository';
...
export class ScreensRestaurantCategoryController extends ApiController {
  constructor(
    @inject('command.bus')
    commandBus: CommandBus,
    @inject('query.bus')
    queryBus: QueryBus,
    @inject('ScreensRestaurantCategoryRepository')
    private repo: ScreensRestaurantCategoryInfrastructureCommandRepository,
