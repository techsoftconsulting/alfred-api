...
import VendorPromotionInfrastructureCommandRepository from '../../../../../src/main/vendor/auth/infrastructure/persistance/typeorm/repositories/vendor-promotion-infrastructure-command-repository';
...
export class PromotionController extends ApiController {
  constructor(
    @inject('command.bus')
    commandBus: CommandBus,
    @inject('query.bus')
    queryBus: QueryBus,
    @inject('VendorPromotionRepository')
    private repo: VendorPromotionInfrastructureCommandRepository,
  ...
  async save(@Body() data: PromotionDto): Promise<any> {
    try {
