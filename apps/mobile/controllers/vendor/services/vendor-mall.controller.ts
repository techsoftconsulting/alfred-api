...
import VendorMallInfrastructureCommandRepository from '../../../../../src/main/vendor/auth/infrastructure/persistance/typeorm/repositories/vendor-mall-infrastructure-command-repository';
...
export class VendorMallController extends ApiController {
  constructor(
    @inject('command.bus')
    commandBus: CommandBus,
    @inject('query.bus')
    queryBus: QueryBus,
    @inject('VendorMallRepository')
    private repo: VendorMallInfrastructureCommandRepository,
