...
import RestaurantPromotionInfrastructureCommandRepository from '@restaurants/auth/infrastructure/persistance/typeorm/repositories/restaurant-promotion-infrastructure-command-repository';
...
export class RestaurantPromotionController extends ApiController {
  constructor(
    @inject('command.bus')
    commandBus: CommandBus,
    @inject('query.bus')
    queryBus: QueryBus,
    @inject('RestaurantPromotionRepository')
    private repo: RestaurantPromotionInfrastructureCommandRepository,
  ...
  async save(@Body() data: RestaurantPromotionDto): Promise<any> {
    try {
