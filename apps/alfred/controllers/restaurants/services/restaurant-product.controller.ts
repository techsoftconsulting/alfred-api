...
import RestaurantProductInfrastructureCommandRepository from '@restaurants/auth/infrastructure/persistance/typeorm/repositories/restaurant-product-infrastructure-command-repository';
...
export class RestaurantProductController extends ApiController {
  constructor(
    @inject('command.bus')
    ...
    private repo: RestaurantProductInfrastructureCommandRepository,
  ...
  async save(@Body() data: RestaurantProductDto): Promise<any> {
    try {
