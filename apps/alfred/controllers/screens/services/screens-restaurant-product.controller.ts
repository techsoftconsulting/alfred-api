...
import ScreensRestaurantProductInfrastructureCommandRepository from '@screens/auth/infrastructure/persistance/typeorm/repositories/screens-restaurant-product-infrastructure-command-repository';
...
@ApiTags('Screens')
@Controller({
  path: 'screens/restaurant-product',
})
export class ScreensRestaurantProductController extends ApiController {
  constructor(
    @inject('command.bus')
    commandBus: CommandBus,
    @inject('query.bus')
    queryBus: QueryBus,
    @inject('ScreensRestaurantProductRepository')
    private repo: ScreensRestaurantProductInfrastructureCommandRepository,
