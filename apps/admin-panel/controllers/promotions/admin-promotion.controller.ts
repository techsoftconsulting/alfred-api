...
import AdminPromotionInfrastructureCommandRepository from '@admin/auth/infrastructure/persistance/typeorm/repositories/promotions/admin-promotion-infrastructure-command-repository';
...
@Controller({
  path: 'admin/restaurant-promotion',
})
export class AdminPromotionController extends ApiController {
  constructor(
    @inject('command.bus')
    commandBus: CommandBus,
    @inject('query.bus')
    queryBus: QueryBus,
    @inject('AdminPromotionRepository')
    private repo: AdminPromotionInfrastructureCommandRepository,
  ...
  async save(@Body() data: AdminPromoDto): Promise<any> {
    try {
